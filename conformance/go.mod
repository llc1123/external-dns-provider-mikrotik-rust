...
require sigs.k8s.io/external-dns v0.23.0
...
require (
	...
	github.com/projectcontour/contour v1.33.7 // indirect
	...
	istio.io/client-go v1.31.0 // indirect
...
replace sigs.k8s.io/external-dns => ../../external-dns
